        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('admin.dahsboard') }}" class="app-brand-link">
              ...
              <img src="{{ asset('dashboard/assets/img/avatars/logo.png') }}" />
              </span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="{{ route('admin.dahsboard') }}" class="menu-link">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="{{ route('all-product') }}" class="menu-link">
                    <div data-i18n="Alerts">All Product</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0)" class="menu-link menu-toggle">
                ...
                <div data-i18n="Extended UI">Order Status</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="extended-ui-perfect-scrollbar.html" class="menu-link">
                    <div data-i18n="Perfect Scrollbar">All Orders</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="extended-ui-text-divider.html" class="menu-link">
                    <div data-i18n="Text Divider">Successfull Orders</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="extended-ui-text-divider.html" class="menu-link">
                    <div data-i18n="Text Divider">Pending Orders</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="extended-ui-text-divider.html" class="menu-link">
                    <div data-i18n="Text Divider">Cancle Orders</div>
                  </a>
                </li>
              </ul>
            </li>
